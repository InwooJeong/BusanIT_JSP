...
<body>
	...
	<form action="form04_process.jsp" name="member" method="post">
		...
		<p> HOBBY : Reading <input type="checkbox" name="hobby1" value="READING" checked>
					Work Out <input type="checkbox" name="hobby2" value="WORK OUT">
					Movie <input type="checkbox" name="hobby3" value="MOVIE"></p>
